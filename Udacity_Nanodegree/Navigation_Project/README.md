...
Alternatively, once you have cloned this repository, you can just create a new virtual environment, activate it, enter the python folder and execute *"pip install ."*.
